...
public class ContactTest { 
 ...
 @Test
  void twoContacts_withSameName_areSeparateObjects() {
    Contact a = new Contact("Ada Lovelace", "555-0001");
    Contact b = new Contact("Ada Lovelace", "555-0002");
    assertNotSame(a, b);
    assertEquals("555-0001", a.getPhone());
    assertEquals("555-0002", b.getPhone());
}
